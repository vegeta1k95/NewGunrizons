        ...
        return (new Weapon.Builder()).withModId("mw")
            ...
            .withCompatibleAttachment(AuxiliaryAttachments.USP45Top, true, (model) -> {
                if (model instanceof P2000Top) {
                    ...
                    GL11.glScaled(0.30000001192092896D, 0.30000001192092896D, 0.2800000011920929D);
                } else if (model instanceof P226frontsight) {
                    GL11.glTranslatef(-0.15F, -1.175F, -2.02F);
                    GL11.glScaled(0.2199999988079071D, 0.2199999988079071D, 0.18000000715255737D);
                }
            ...
            .withTextureNames("USP45", "Electric")
            .withRenderer(
                (new WeaponRenderer.Builder()).withModId("mw")
                    ...
                    .withFirstPersonPositioningCustomRecoiled(
                        AuxiliaryAttachments.USP45Top.getRenderablePart(),
