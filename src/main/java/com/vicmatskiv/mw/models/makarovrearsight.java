...
public class makarovrearsight extends ModelBase {
    ...
    public makarovrearsight() {
        ...
        this.sight1.addBox(0.0F, 0.0F, 0.0F, 2, 2, 2);
        this.sight1.setRotationPoint(-1.7F, -1.8F, -1.0F);
        ...
        this.sight2.addBox(0.0F, 0.0F, 0.0F, 1, 5, 2);
        this.sight2.setRotationPoint(-2.0F, -1.8F, -1.0F);
        ...
        this.sight3.addBox(0.0F, 0.0F, 0.0F, 2, 2, 2);
        this.sight3.setRotationPoint(2.7F, -1.8F, -1.0F);
        ...
        this.sight4.addBox(0.0F, 0.0F, 0.0F, 1, 5, 2);
        this.sight4.setRotationPoint(4.0F, -1.8F, -1.0F);
        ...
        this.sight5.addBox(0.0F, 0.0F, 0.0F, 3, 3, 2);
        this.sight5.setRotationPoint(1.7F, -0.2F, -1.0F);
        ...
        this.sight6.addBox(0.0F, 0.0F, 0.0F, 4, 3, 2);
        this.sight6.setRotationPoint(-1.7F, -0.2F, -1.0F);
        this.sight6.setTextureSize(64, 32);
        this.sight6.mirror = true;
        this.setRotation(this.sight6, 0.0F, 0.0F, 0.0F);
        this.sigh8 = new ModelRenderer(this, 0, 0);
        this.sigh8.addBox(0.0F, 0.0F, 0.0F, 1, 4, 2);
        this.sigh8.setRotationPoint(5.0F, -0.8F, -1.0F);
        this.sigh8.setTextureSize(64, 32);
        this.sigh8.mirror = true;
        this.setRotation(this.sigh8, 0.0F, 0.0F, 0.0F);
        this.sight9 = new ModelRenderer(this, 0, 0);
        this.sight9.addBox(0.0F, 0.0F, 0.0F, 1, 4, 2);
        this.sight9.setRotationPoint(-3.0F, -0.8F, -1.0F);
        ...
        this.sight10.addBox(0.0F, 0.0F, 0.0F, 1, 1, 2);
        this.sight10.setRotationPoint(5.0F, -1.8F, -1.0F);
        ...
        this.sight14.addBox(0.0F, 0.0F, 0.0F, 9, 1, 7);
        this.sight14.setRotationPoint(-3.0F, 2.2F, -3.5F);
        ...
        this.sight15.addBox(0.0F, 0.0F, 0.0F, 9, 2, 3);
        this.sight15.setRotationPoint(-3.0F, 2.2F, -3.5F);
        this.sight15.setTextureSize(64, 32);
        this.sight15.mirror = true;
        this.setRotation(this.sight15, 0.5576792F, 0.0F, 0.0F);
        this.sight16 = new ModelRenderer(this, 0, 0);
        this.sight16.addBox(0.0F, 0.0F, 0.0F, 9, 3, 2);
        this.sight16.setRotationPoint(-3.0F, 2.2F, 3.5F);
        this.sight16.setTextureSize(64, 32);
        this.sight16.mirror = true;
        this.setRotation(this.sight16, -2.119181F, 0.0F, 0.0F);
    }
