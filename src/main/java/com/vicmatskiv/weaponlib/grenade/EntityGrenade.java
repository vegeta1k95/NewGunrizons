...
import com.vicmatskiv.weaponlib.BlockPos;
import com.vicmatskiv.weaponlib.BlockState;
import com.vicmatskiv.weaponlib.Explosion;
import com.vicmatskiv.weaponlib.ModContext;
import com.vicmatskiv.weaponlib.RayTracing;
    ...
    public void onUpdate() {
        if (!this.worldObj.isRemote && this.ticksExisted > MAX_TICKS) {
            ...
            if (!this.stopped) {
                ...
                MovingObjectPosition movingobjectposition = RayTracing.rayTraceBlocks(
                    this.worldObj,
                    vec3,
                    vec31,
                    this::canCollideWithBlock);
        ...
        if (this.explosionTimeout == -1L && !this.worldObj.isRemote) {
            ...
            if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK
                ...
                if (bounceHardSound != null) {
                    ...
                    if (madeFromHardMaterial(blockState)) {
                        this.worldObj.playSoundAtEntity(
                            this, bounceHardSound, 2.0F / ((float) this.bounceCount + 1.0F), 1.0F);
                    }
                }
                ...
                if (bounceSoftSound != null) {
                    ...
                    if (!madeFromHardMaterial(blockState)) {
                        this.worldObj.playSoundAtEntity(
                            this, bounceSoftSound, 1.0F / ((float) this.bounceCount + 1.0F), 1.0F);
                    }
                }
            }
        }
    ...
    private void explode() {
        ...
        for (int i = 0; (float) i < configuredFragmentCount; ++i) {
            ...
            if (d2 == 0.0D) {
                ...
                BiPredicate<Block, BlockState> isCollidable = (block, blockMetadata) ->
                    block.canCollideCheck(blockMetadata.getBlockMetadata(), false);
                ...
                for (Object nearbyEntityObject : nearbyEntities) {
                    ...
                    if (nearbyEntity.canBeCollidedWith()) {
                        float f = 0.5F;
                        AxisAlignedBB axisalignedbb = nearbyEntity.boundingBox
                            .expand(f, f, f);
                        ...
                        if (movingobjectposition1 != null) {
                            ...
                            logger.trace(
                                ...
                                nearbyEntity, distanceToEntity, damageDistanceReductionFactor);
