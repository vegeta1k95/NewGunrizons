...
import com.gtnewhorizon.newgunrizons.model.weapon.MPX;
        ...
        return (new ItemWeapon.Builder()).withModId("newgunrizons")
            ...
            .withCompatibleAttachment(AuxiliaryAttachments.Extra, true, (model) -> {
                if (model instanceof M4Iron1) {
                    ...
                    GL11.glTranslatef(0.125F, -1.8F, 0.0F);
                    GL11.glScaled(0.0D, 0.0D, 0.0D);
                    ...
                    GL11.glScaled(0.6000000238418579D, 0.699999988079071D, 0.20000000298023224D);
            ...
            .withRenderer(
                (new WeaponRenderer.Builder()).withModId("newgunrizons")
                    ...
                    .withFirstPersonPositioning((renderContext) -> {
                        ...
                        GL11.glTranslatef(-0.5F, 1.1F, -0.9F);
                    })
                    ...
                    .withFirstPersonCustomPositioningReloading(Magazines.MPXmag, new Transition((renderContext) -> {
                        GL11.glTranslatef(0.3F, 1.7F, 0.1F);
                        GL11.glRotatef(-30.0F, 0.0F, 0.0F, 1.0F);
                    }, 250L, 1000L),
                        new Transition((renderContext) -> { GL11.glTranslatef(-0.01F, 0.0F, 0.0F); }, 250L, 1000L),
