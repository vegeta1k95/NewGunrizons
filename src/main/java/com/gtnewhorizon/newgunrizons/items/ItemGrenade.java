...
public class ItemGrenade extends Item
    ...
    private ItemGrenade(ItemGrenade.Builder builder, ModContext modContext) {
    ...
    public double getTotalThrowingDuration() {
        return (double) this.renderer.getTotalThrowingDuration();
    }
    ...
    public Collection<CompatibleAttachment> getCompatibleAttachments(AttachmentCategory... categories) {
        Collection<CompatibleAttachment> c = this.compatibleAttachments.values();
