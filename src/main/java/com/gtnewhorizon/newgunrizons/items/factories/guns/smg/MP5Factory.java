...
import com.gtnewhorizon.newgunrizons.model.weapon.MP5;
...
public class MP5Factory {
    ...
    public Item createGun() {
        return (new ItemWeapon.Builder()).withName("HKMP5")
            .withFireRate(0.75F)
            .withRecoil(2.7F)
            ...
            .withTextureName("MP5")
            .withRenderer(
                (new WeaponRenderer.Builder()).withModel(new MP5())
