...
public class USP45Factory {

    public Item createGun() {
        return (new ItemWeapon.Builder()).withName("HKUSP45")
            .withFireRate(0.4F)
            .withRecoil(5.0F)
            ...
            .withCompatibleAttachment(Magazines.ColtM1911Mag, ((model) -> { GL11.glTranslatef(0.0F, 0.15F, 0.0F); }))
