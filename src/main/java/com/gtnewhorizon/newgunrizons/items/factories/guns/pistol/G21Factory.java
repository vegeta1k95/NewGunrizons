...
public class G21Factory {
    ...
    public Item createGun() {
        return (new ItemWeapon.Builder()).withName("Glock21")
            .withFireRate(0.8F)
            .withRecoil(5.5F)
            ...
            .withCompatibleAttachment(Magazines.Glock21Mag, ((model) -> { GL11.glTranslatef(0.0F, 0.1F, 0.1F); }))
            ...
            .withRenderer(
                (new WeaponRenderer.Builder()).withModel(new JsonModel("weapon/glock"))
                    ...
                    .withFirstPersonPositioningCustomRecoiled(
                        AuxiliaryAttachments.Glock21Slide.getRenderablePart(),
