...
import com.gtnewhorizon.newgunrizons.model.weapon.POFUSA;
...
public class POFUSAFactory {
    ...
    public Item createGun() {
        return (new ItemWeapon.Builder()).withName("POF308")
            .withFireRate(0.55F)
            .withRecoil(6.0F)
            ...
            .withInformationProvider(
                (stack) -> Arrays.asList(
                    ...
                    "Fire Rate: Auto"))
            .withCompatibleAttachment(Magazines.Mag308, ((model) -> { GL11.glScaled(1.0D, 1.0D, 1.0D); }))
            ...
            .withRenderer(
                (new WeaponRenderer.Builder()).withModel(new POFUSA())
                    ...
                    .withFirstPersonPositioning((renderContext) -> {
                        ...
                        GL11.glTranslatef(-0.45F, 1.05F, -0.8F);
                    })
                    .withFirstPersonPositioningRecoiled((renderContext) -> {
                        GL11.glRotatef(45.0F, 0.0F, 1.0F, 0.0F);
                        GL11.glScalef(3.0F, 3.0F, 3.0F);
                        GL11.glRotatef(1.0F, 0.0F, 0.0F, 1.0F);
                        GL11.glTranslatef(-0.45F, 1.05F, -0.7F);
                    ...
                    .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                        ...
                        if (ItemWeapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.MicroT1)) {
                            GL11.glTranslatef(0.0F, 0.09F, 0.3F);
                        }
