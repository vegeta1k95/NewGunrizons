...
import com.gtnewhorizon.newgunrizons.model.weapon.P99;
...
public class P99Factory {
    ...
    public Item createGun() {
        return (new ItemWeapon.Builder()).withName("P99")
            .withFireRate(0.6F)
            .withRecoil(6.0F)
            ...
            .withTextureName("P99")
            .withRenderer(
                (new WeaponRenderer.Builder()).withModel(new P99())
                    ...
                    .withFirstPersonPositioning((renderContext) -> {
                        ...
                        GL11.glTranslatef(-0.75F, 0.8F, -3.3F);
                    })
                    .withFirstPersonPositioningRecoiled((renderContext) -> {
                        GL11.glRotatef(45.0F, 0.0F, 1.0F, 0.0F);
                        GL11.glRotatef(4.0F, 0.0F, 0.0F, 1.0F);
                        GL11.glScaled(3.0D, 3.0D, 3.0D);
                        GL11.glTranslatef(-0.75F, 0.8F, -3.1F);
                        GL11.glRotatef(-7.0F, 1.0F, 0.0F, 0.0F);
                    })
                    .withFirstPersonPositioningCustomRecoiled(
                        AuxiliaryAttachments.P99Slide.getRenderablePart(),
                    ...
                    .withFirstPersonPositioningRunning((renderContext) -> {
                        ...
                        GL11.glTranslatef(-0.7F, 2.0F, -1.3F);
                    })
                    ...
                    .withFirstPersonHandPositioningModifying((renderContext) -> {
                        ...
                        GL11.glTranslatef(0.425F, -0.50001F, 0.15F);
                    })
                    ...
                    .withFirstPersonRightHandPositioningReloading(new Transition((renderContext) -> {
                        ...
                        GL11.glRotatef(-10.0F, 0.0F, 1.0F, 0.0F);
                        GL11.glRotatef(-35.0F, 0.0F, 0.0F, 1.0F);
                        GL11.glTranslatef(0.425F, -0.525F, 0.125F);
                    }, 250L, 0L), new Transition((renderContext) -> {
                        GL11.glScalef(4.0F, 4.0F, 4.0F);
                        GL11.glRotatef(-90.0F, 1.0F, 0.0F, 0.0F);
