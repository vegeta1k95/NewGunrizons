...
public class PlayerWeaponInstance extends PlayerItemInstance<WeaponState> {
    ...
    public PlayerWeaponInstance() {
        this.BLUR_SOURCE = (new DynamicShaderGroupSource(
            BLUR_SOURCE_UUID,
            new ResourceLocation("newgunrizons:/com/gtnewhorizon/newgunrizons/resources/blur.json")))
        ...
        this.NIGHT_VISION_SOURCE = (new DynamicShaderGroupSource(
            ...
            new ResourceLocation("newgunrizons:/com/gtnewhorizon/newgunrizons/resources/night-vision.json")))
                .withUniform(
                    "IntensityAdjust",
        ...
        this.VIGNETTE_SOURCE = (new DynamicShaderGroupSource(
            ...
            new ResourceLocation("newgunrizons:/com/gtnewhorizon/newgunrizons/resources/vignette.json")))
